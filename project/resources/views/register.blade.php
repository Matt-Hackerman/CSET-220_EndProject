<html>
  ...
  <body>
    ...
    <div class="parent">
      ...
      <div class="child">
        <div class=button2>Date of Birth</div>
        <input type="date">
      </div>
    </div>
    <br>
    <div class="parent">
      <div class="child">
        <div class=button2>First Name</div>
        <input type="text">
      </div>
      <div class="child">
    ...
    <div class="parent">
      <div class="child">
        <div class=button2>Last Name</div>
        <input>
      </div>
      <div class="child">
        <div class=othertest id=patientonly2>
          <div class=button2>Emergency Contact</div>
          <input>
        </div>
      </div>
    </div>
    ...
    <div class="parent">
      <div class="child">
        <div class=button2>Email ID </div>
        <input>
      </div>
      <div class="child">
        <div class=othertest id=patientonly3>
          <div class=button2>Relation to Emergency Contact</div>
          <input>
        </div>
      </div>
    </div>
    ...
    <div class="parent" style=display:inline-block>
      <div class="child">
        <div class=button2>Password</div>
        <input>
      </div>
